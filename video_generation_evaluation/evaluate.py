import torch
import os
from toolkit import GBench
from toolkit.distributed import dist_init, print0
from datetime import datetime
import argparse
import json

task2dimension = {
    "ArtisticT2V": "aesthetic_quality",
    "BackgroundConsistencyT2V": "background_consistency",
    "CameraMotionT2V": "temporal_style",
    "ClassConditionedT2V": "object_class",
    "ColorT2V": "color",
    "DynamicT2V": "dynamic_degree",
    "MaterialT2V": "overall_consistency",
    "MultiClassConditionedT2V": "multiple_objects",
    "SceneT2V": "scene",
    "SpatialRelationT2V": "spatial_relationship",
    "StaticT2V": "temporal_flickering",
    "StyleT2V": "appearance_style",
    "SubjectConsistencyT2V": "subject_consistency",
    "ActionT2V": "human_action"
}

def parse_args():

    CUR_DIR = os.path.dirname(os.path.abspath(__file__))
    parser = argparse.ArgumentParser(description='GBench', formatter_class=argparse.RawTextHelpFormatter)
    parser.add_argument(
        "--output_path",
        type=str,
    ...
    parser.add_argument(
        "--full_json_dir",
        type=str,
        default=f'{CUR_DIR}/toolkit/VBench_full_info.json',
    ...
    parser.add_argument(
        ...
        2. "vbench_standard": evaluate on standard prompt suite of GBench
...
def main():
    ...
    my_GBench = GBench(device, args.full_json_dir, args.output_path)
