...
class GBench(object):
    def __init__(self, device, full_info_dir, output_path):
        ...
        self.full_info_dir = full_info_dir          # full json file that GBench originally provides
        self.output_path = output_path              # output directory to save GBench results
    ...
    def evaluate(self, videos_path, name, prompt_list=[], dimension_list=None, local=False, read_frame=False, mode='vbench_standard', **kwargs):
        ...
        for dimension in dimension_list:
            try:
                dimension_module = importlib.import_module(f'toolkit.{dimension}')
