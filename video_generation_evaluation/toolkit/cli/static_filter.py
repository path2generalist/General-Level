...
from toolkit.utils import CACHE_DIR, get_prompt_from_filename, load_json
from toolkit.third_party.RAFT.core.raft import RAFT
from toolkit.third_party.RAFT.core.utils_core.utils import InputPadder
...
def register_subparsers(subparser):
    ...
    parser.add_argument('--filter_scope', default='temporal_flickering', help=f'''For specifying the scope for filtering videos
        1. 'temporal_flickering' (default): filter videos based on matches with temporal_flickering dimension of GBench.
